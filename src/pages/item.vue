...
<template>
  ...
  <div class="xl:grid xl:grid-cols-3 xl:mx-6 xl:gap-6">
    <swiper
      ...
      :space-between="50"
      navigation
      class="lg:w-full lg:col-span-2"
      :pagination="{ clickable: true }"
    >
      <swiper-slide v-if="!multipleImages">
        <img
          class="w-full grid place-items-center object-contain lg:h-96 bg-white p-10 shadow-2xl rounded-lg text-center mt-4"
          :src="checkForImage()"
        />
      </swiper-slide>
  ...
  >
    ...
    <div
      class="flex flex-col gap-6 bg-gray-50 shadow-md dark:bg-slate-900 rounded-xl p-4 pb-8 lg:col-span-2"
    >
